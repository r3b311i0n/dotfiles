...
plugins=(adb archlinux battery cargo colored-man-pages colorize cp docker docker-compose dotenv extract gem git-extras git github gitignore gnu-utils gradle history-substring-search history httpie man node npm npx nvm pip python react-native rsync rust screen shrink-path systemd zsh_reload)
