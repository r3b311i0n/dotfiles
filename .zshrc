...
plugins=(archlinux battery bundler command-not-found colored-man-pages colorize cp docker dotenv extract gem git-extras git github gitignore gnu-utils gradle history-substring-search history httpie man ng node npm nyan pip python react-native rsync rust screen shrink-path systemd yarn zsh_reload)
