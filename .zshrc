...
plugins=(archlinux battery bundler cargo colored-man-pages colorize cp docker docker-compose dotenv extract gem git-extras git github gitignore gnu-utils go gradle history-substring-search history httpie man ng node npm npx nvm pip python react-native rsync rust screen shrink-path systemd zsh_reload)
...
alias mpv-dm="MESA_LOADER_DRIVER_OVERRIDE=i965 mpv --ytdl-format=hls-240-0"
